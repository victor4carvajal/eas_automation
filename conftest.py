...
from conf.utils_conf import browser_os_name_conf
from conf.utils_conf import base_url_conf
from conf.utils_conf import report_portal_conf
...
def pytest_addoption(parser):
    ...
    try:
        ...
        parser.addoption("--avoid_stats",
                            dest="avoid_stats",
                            action="store_true",
                            default=True,
                            help="Avoid sends usage statistics to plausible.io. Default: True")
